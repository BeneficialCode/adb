...
#include "LocaleDataTables.cpp"
    ...
    // any results in 'out'.)
    size_t findAncestors(uint32_t* out, size_t* stop_list_index,
    ...
    size_t findDistance(uint32_t supported,
        ...
        size_t request_ancestors_index;
