...
#define BUILD_NUMBER "7562133"
#define PLATFORM_TOOLS_VERSION "31.0.3"
...
std::string adb_version() {
    return android::base::StringPrintf(
        ...
        BUILD_NUMBER, android::base::GetExecutablePath().c_str(),
        GetOSVersion().c_str());
}
...
static unsigned _redirect_pipe_thread(HANDLE h, DWORD nStdHandle) {
    ...
    const int       original_fd = _fileno(nStdHandle == STD_OUTPUT_HANDLE ? stdout : stderr);
